...
biocLite("rhdf5")
```
A .h5 file generated by timeclust is required as input. More information on this will be available in the [timeclust GitHub repository](https://github.com/beiko-lab/timeclust/).
